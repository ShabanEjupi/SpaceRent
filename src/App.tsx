      ...
      <header className="h-20 bg-black/50 backdrop-blur-md border-b border-white/10 sticky top-0 z-50">
        <div className="h-full px-4 sm:px-8 max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            <Link
              to="/"
              className="hidden sm:flex w-12 h-12 bg-gradient-to-br from-[#E2B808] to-[#9A7D0A] rounded-xl items-center justify-center shadow-[0_0_20px_rgba(226,184,8,0.2)]"
            >
              <svg
                width="24"
                height="24"
            ...
            <Link to="/" className="flex flex-col">
              ...
              <span className="text-[10px] tracking-[0.4em] text-[#E2B808] font-bold">
                KOSOVO MISSION CONTROL
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-8">
              ...
              <Link
                ...
                className={`transition-colors ${
                  location.pathname === "/" || location.pathname === "/search"
                    ? "text-[#E2B808] border-b-2 border-[#E2B808] pb-1"
            ...
            <div className="hidden sm:flex bg-white/5 rounded-full p-1 border border-white/10 ring-1 ring-white/5">
              <button
                ...
                className={`px-4 py-1.5 text-[10px] font-black rounded-full transition-all ${
                  i18n.language === "sq"
                    ? "bg-[#E2B808] text-black shadow-lg"
            ...
            <div className="hidden sm:flex ml-2">
              {user ? (
                ...
                <Link
                  to="/auth"
                  className="bg-[#E2B808] text-black px-4 py-2 text-[10px] uppercase font-black tracking-widest rounded-xl shadow-[0_2px_10px_rgba(226,184,8,0.2)] hover:scale-105 transition-transform"
                >
                  {t("login")}
                </Link>
              )}
          ...
          <div className="sm:hidden absolute top-20 left-0 w-full bg-black/95 border-b border-white/10 p-4 flex flex-col gap-4">
            ...
            {user ? (
              <button
                ...
                className="text-left text-xs font-bold uppercase tracking-widest text-white/40"
              >
                {t("logout")}
              </button>
            ) : (
